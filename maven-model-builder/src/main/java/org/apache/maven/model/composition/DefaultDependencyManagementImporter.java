                                  ...
                                  final ModelBuildingRequest request, final ModelProblemCollector problems )
    {
        if ( sources != null && !sources.isEmpty() )
        {
            ...
            for ( final List<Dependency> conflictCanditates : sourceDependencies.values() )
            {
                ...
                // First declaration wins. This makes the conflict resolution indeterministic because this
                ...
                // As of Maven 3.6, we print a warning about such conflicting imports.
